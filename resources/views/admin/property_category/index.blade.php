...
@section('title', 'Madalali4u | All Property categories')
...
<div class="container-xl"> 
      ...
      <div class="row g-2 align-items-center">
              ...
              <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                  <a href="{{ route('admin.property_category.create')}}" class="btn btn-primary d-none d-sm-inline-block" >
  ...
  <div class="container-xl">
    ...
    <div class="card">
      ...
      <div class="card-body">
          ...
          @include('admin.property_category.message')
            ...
            @else
                @include('admin.property_category.table')
            @endif
