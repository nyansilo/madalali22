...
<script type="text/javascript" src="{{ asset('front_end/js/isotop.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('front_end/js/progressbar.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('front_end/js/googlemaps1.js') }}"></script>
