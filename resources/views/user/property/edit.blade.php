...
@section('title', 'Madalali4u | Edit Property')
    ...
    <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
              <div class="col">
                ...
                <div class="text-muted mt-1"><a href="{{ url('/admin/dashboard') }}"> Dashboard</a> > Edit Property</div>
      ...
      <div class="container-xl">
            ...
            <div class="row row-cards">
               ...
               {!! Form::model($property, [
                            ...
                            'method' => 'PUT',
                            'route'  => ['admin.property.update', $property->id],
                            'files'  => TRUE,
                            'id' => 'post-form'
                        ]) 
