      ...
      <div class="my_dashboard_review">
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="my_profile_setting_input form-group">
                <label for="propertyTitle">Slug</label>
                <input type="text" class="form-control" id="propertyTitle">
            </div>
          </div>
          ...
          <div class="col-lg-12">
            <div class="my_profile_setting_input ui_kit_select_search form-group">
              ...
              <select class="selectpicker" data-live-search="true" data-width="100%">
                <option data-tokens="type1">For Rent</option>
                <option data-tokens="Type2">For Sale</option>
...
<div class="col-lg-4">
     ...
     <div class="my_dashboard_review mt30">
        <div class="row">
          <div class="col-lg-12">
            <h4 class="mb30">Property Area</h4>
            
          </div>

          <div class="col-lg-12">           
            <div class="my_profile_setting_input form-group">
                <label for="propertyAddress">Area</label>
                <input type="text" class="form-control" id="propertyAddress">
            </div>
          </div>
      ...
      <div class="my_dashboard_review mt30">
        <div class="row">
          <div class="col-lg-12">
            <h4 class="mb30">Vehicle Features</h4>
          </div>

          <div class="col-lg-12">           
            <div class="my_profile_setting_input form-group">
                <label for="propertyAddress">Brand</label>
                <input type="text" class="form-control" id="propertyAddress">
            </div>
          </div>
          ...
          <div class="col-lg-12">           
            <div class="my_profile_setting_input form-group">
                <label for="propertyAddress">Coverage</label>
                <input type="text" class="form-control" id="propertyAddress">
            </div>
          </div>
          ...
          <div class="col-lg-12">           
            <div class="my_profile_setting_input form-group">
                <label for="propertyAddress">Engine Capacity</label>
                <input type="text" class="form-control" id="propertyAddress">
            </div>
          </div>
          ...
          <div class="col-lg-12">           
            <div class="my_profile_setting_input form-group">
                <label for="propertyAddress">Color</label>
                <input type="text" class="form-control" id="propertyAddress">
            </div>
          </div>
